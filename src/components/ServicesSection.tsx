...
const services = [
  {
    ...
    description:
      "Acompañamiento completo desde la selección de programas hasta la postulación final. Analizamos tu perfil y encontramos las becas que mejor se ajustan a tus metas.",
    features: [
  ...
  },
  {
    ...
    description:
      "Desarrollo y revisión de todos los documentos necesarios para tu aplicación, asegurando que cada palabra refleje tu potencial.",
    features: [
      "Statement of Purpose personalizado",
  ...
  },
  {
    ...
    description:
      "Simulacros y coaching para que llegues seguro y preparado a cada entrevista, ya sea presencial o virtual.",
    features: [
  ...
  },
  {
    ...
    description:
      "Sesiones grupales diseñadas para quienes desean iniciar su camino hacia una beca con una comunidad de apoyo.",
    features: [
      "Webinars informativos mensuales",
      "Bootcamps intensivos",
      "Grupos de estudio y accountability",
      "Networking con becarios exitosos",
    ],
  },
];
      ...
      <div className="container-wide">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="bg-card rounded-2xl p-8 card-elevated group hover:bg-primary transition-colors duration-300"
            >
              ...
              <ul className="space-y-3">
                {service.features.map((feature, idx) => (
                  <li
                    key={idx}
                    className="flex items-center gap-3 text-sm text-muted-foreground group-hover:text-primary-foreground/80 transition-colors"
                  >
        ...
        <div className="text-center mt-12">
          <Button variant="default" size="xl" asChild>
            <a href="#contacto">Solicitar información de servicios</a>
          </Button>
        </div>
      </div>
    </section>
