...
export function ContactSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setFormData({ name: "", email: "", phone: "", beca: "", message: "" });
  };
              ...
              <div className="grid sm:grid-cols-2 gap-5">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="erasmus">Erasmus Mundus</option>
                    <option value="otra">Otra / No sé aún</option>
                  </select>
                </div>
              </div>
              <div>
                ...
                <textarea
                  ...
                  placeholder="Cuéntanos sobre tus metas y cómo podemos ayudarte..."
                />
              </div>
            ...
            <div className="bg-card rounded-2xl p-8 card-elevated space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:mardebecas@gmail.com"
